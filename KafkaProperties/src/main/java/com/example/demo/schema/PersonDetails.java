...
public class PersonDetails extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 6850939754608901125L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PersonDetails\",\"namespace\":\"com.example.demo.schema\",\"fields\":[{\"name\":\"empId\",\"type\":\"int\"},{\"name\":\"firstName\",\"type\":[\"null\",\"string\"]},{\"name\":\"lastName\",\"type\":[\"null\",\"string\"]},{\"name\":\"age\",\"type\":\"int\"},{\"name\":\"sex\",\"type\":[\"null\",\"string\"]}]}");
   ...
   */
  public static com.example.demo.schema.PersonDetails.Builder newBuilder() {
    return new com.example.demo.schema.PersonDetails.Builder();
  }
   ...
   * @return A new PersonDetails RecordBuilder
   */
  public static com.example.demo.schema.PersonDetails.Builder newBuilder(com.example.demo.schema.PersonDetails.Builder other) {
    return new com.example.demo.schema.PersonDetails.Builder(other);
  }
   ...
   * @return A new PersonDetails RecordBuilder
   */
  public static com.example.demo.schema.PersonDetails.Builder newBuilder(com.example.demo.schema.PersonDetails other) {
    return new com.example.demo.schema.PersonDetails.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PersonDetails>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.demo.schema.PersonDetails.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.demo.schema.PersonDetails other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.empId)) {
        this.empId = data().deepCopy(fields()[0].schema(), other.empId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.schema.PersonDetails.Builder setEmpId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.schema.PersonDetails.Builder clearEmpId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.schema.PersonDetails.Builder setFirstName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.schema.PersonDetails.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.schema.PersonDetails.Builder setLastName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.schema.PersonDetails.Builder clearLastName() {
      lastName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.schema.PersonDetails.Builder setAge(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.schema.PersonDetails.Builder clearAge() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.schema.PersonDetails.Builder setSex(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.schema.PersonDetails.Builder clearSex() {
      sex = null;
