...
public class VehicleDetails extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1546553250977164726L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"VehicleDetails\",\"namespace\":\"com.example.demo.schema\",\"fields\":[{\"name\":\"empId\",\"type\":\"int\"},{\"name\":\"vehicleNo\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"vehicleName\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"insurance\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"manufacturingYear\",\"type\":\"int\"}]}");
   ...
   */
  public static com.example.demo.schema.VehicleDetails.Builder newBuilder() {
    return new com.example.demo.schema.VehicleDetails.Builder();
  }
   ...
   * @return A new VehicleDetails RecordBuilder
   */
  public static com.example.demo.schema.VehicleDetails.Builder newBuilder(com.example.demo.schema.VehicleDetails.Builder other) {
    return new com.example.demo.schema.VehicleDetails.Builder(other);
  }
   ...
   * @return A new VehicleDetails RecordBuilder
   */
  public static com.example.demo.schema.VehicleDetails.Builder newBuilder(com.example.demo.schema.VehicleDetails other) {
    return new com.example.demo.schema.VehicleDetails.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<VehicleDetails>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.demo.schema.VehicleDetails.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.demo.schema.VehicleDetails other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.empId)) {
        this.empId = data().deepCopy(fields()[0].schema(), other.empId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.schema.VehicleDetails.Builder setEmpId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.schema.VehicleDetails.Builder clearEmpId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.schema.VehicleDetails.Builder setVehicleNo(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.schema.VehicleDetails.Builder clearVehicleNo() {
      vehicleNo = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.schema.VehicleDetails.Builder setVehicleName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.schema.VehicleDetails.Builder clearVehicleName() {
      vehicleName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.schema.VehicleDetails.Builder setInsurance(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.schema.VehicleDetails.Builder clearInsurance() {
      insurance = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.schema.VehicleDetails.Builder setManufacturingYear(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.schema.VehicleDetails.Builder clearManufacturingYear() {
