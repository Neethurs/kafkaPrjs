...
public class AddressDetails extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4040609044202734359L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AddressDetails\",\"namespace\":\"com.example.kafka.schema\",\"fields\":[{\"name\":\"empId\",\"type\":\"int\"},{\"name\":\"houseName\",\"type\":[\"null\",\"string\"]},{\"name\":\"streetName\",\"type\":[\"null\",\"string\"]},{\"name\":\"city\",\"type\":[\"null\",\"string\"]},{\"name\":\"postCode\",\"type\":[\"null\",\"string\"]},{\"name\":\"district\",\"type\":[\"null\",\"string\"]},{\"name\":\"state\",\"type\":[\"null\",\"string\"]},{\"name\":\"country\",\"type\":[\"null\",\"string\"]}]}");
   ...
   */
  public static com.example.kafka.schema.AddressDetails.Builder newBuilder() {
    return new com.example.kafka.schema.AddressDetails.Builder();
  }
   ...
   * @return A new AddressDetails RecordBuilder
   */
  public static com.example.kafka.schema.AddressDetails.Builder newBuilder(com.example.kafka.schema.AddressDetails.Builder other) {
    return new com.example.kafka.schema.AddressDetails.Builder(other);
  }
   ...
   * @return A new AddressDetails RecordBuilder
   */
  public static com.example.kafka.schema.AddressDetails.Builder newBuilder(com.example.kafka.schema.AddressDetails other) {
    return new com.example.kafka.schema.AddressDetails.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AddressDetails>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.kafka.schema.AddressDetails.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.kafka.schema.AddressDetails other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.empId)) {
        this.empId = data().deepCopy(fields()[0].schema(), other.empId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.schema.AddressDetails.Builder setEmpId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.schema.AddressDetails.Builder clearEmpId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.schema.AddressDetails.Builder setHouseName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.schema.AddressDetails.Builder clearHouseName() {
      houseName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.schema.AddressDetails.Builder setStreetName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.schema.AddressDetails.Builder clearStreetName() {
      streetName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.schema.AddressDetails.Builder setCity(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.schema.AddressDetails.Builder clearCity() {
      city = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.schema.AddressDetails.Builder setPostCode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.schema.AddressDetails.Builder clearPostCode() {
      postCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.schema.AddressDetails.Builder setDistrict(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.schema.AddressDetails.Builder clearDistrict() {
      district = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.schema.AddressDetails.Builder setState(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.schema.AddressDetails.Builder clearState() {
      state = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.schema.AddressDetails.Builder setCountry(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.schema.AddressDetails.Builder clearCountry() {
      country = null;
